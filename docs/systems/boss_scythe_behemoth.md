...
- [ ] **B2-3 관절 파열·낫 잠김·절뚝·완벽 회피** — rupture/bladeLock 600/limp/`retreatWhenDisarmed`, impact 의 `reaches && iframeTicks>0` → `charge_dodged` + 미끄러짐 90 + 양 관절 40, `boss_status` 이벤트 + Stage 파열·미끄러짐 연출. ▶ 통제 노선·회피 보상.
